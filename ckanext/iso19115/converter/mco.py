...
class MD_Constraints:
    ...
    responsibleParty: list[types.cit.CI_Responsibility] = field(default_factory=list)
...
class MD_Releasability:
    ...
    disseminationConstraints: list[str] = field(default_factory=list) # codelist("MD_RestrictionCode")
