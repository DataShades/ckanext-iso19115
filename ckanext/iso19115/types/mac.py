...
class MI_Objective:
    ...
    type: Optional[list[Codelist[mac.MI_ObjectiveTypeCode]]] = field(default_factory=list)
...
class MI_Plan:
    ...
    satisfiedRequirement: Optional[list[mac.MI_Requirement]] = field(default_factory=list)
...
class MI_Platform:
    ...
    history: Optional[list[mac.MI_InstrumentationEventList]] = field(default_factory=list)
...
class MI_InstrumentationEvent:
    ...
    description: gco.CharacterString = None
    extent: Optional[list[gex.EX_Extent]] = field(default_factory=list)
    type: list[Codelist[mac.MI_InstrumentationEventTypeCode]] = field(default_factory=list)
...
class MI_InstrumentationEventList:
    ...
    metadataConstraints: Optional[list[mco.MD_Constraints]] = field(default_factory=list)
    instrumentationEvent: list[mac.MI_InstrumentationEvent] = field(default_factory=list)
...
class MI_AcquisitionInformation:
    ...
    objective: Optional[list[mac.MI_Objective]] = field(default_factory=list)
    acquisitionRequirement: Optional[list[mac.MI_Requirement]] = field(default_factory=list)
